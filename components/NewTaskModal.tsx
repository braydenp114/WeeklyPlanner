...
import { createTask, updateTask, updateSeries, CreateTaskData, TaskRecurrence, BusyStatus, Visibility, CustomRecurrenceRule } from '@/services/tasksService';
...
export default function NewTaskModal({ visible, onClose, onSaved, prefillDate, prefillHour }: NewTaskModalProps) {
  ...
  }, [title, startDate, endDate, allDay, recurrence, customRecurrenceRule, location, locationCoordinates, notifications, busyStatus, visibility, description, colorHex, onSaved, onClose, editTaskData, editTaskScope]);
